                        ...
                        <div className='row p-4'>
                            <div className='col-12 col-lg-10 mx-auto'>
                                <div className='d-lg-flex justify-content-between gap-4'>
                                    <div className='w-100 w-lg-50' data-aos="zoom-in" data-aos-duration="1500">
                                ...
                                <div className='d-lg-flex justify-content-between gap-4 py-3'>
                                    <div className='w-100 w-lg-50' data-aos="zoom-in" data-aos-duration="1500" data-aos-delay="400">
                                ...
                                <div className='d-lg-flex justify-content-between gap-4'>
                                    <div className='w-100 w-lg-50' data-aos="zoom-in" data-aos-duration="1500" data-aos-delay="600">
                                ...
                                <div className='py-3' data-aos="zoom-in" data-aos-duration="1500" data-aos-delay="800">
                                ...
                                <div className='text-center py-3' data-aos="zoom-in" data-aos-duration="1500" data-aos-delay="1000">
                                    <button
                                        type="button"
