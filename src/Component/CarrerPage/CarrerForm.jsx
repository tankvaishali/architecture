              ...
              <div className="col-12 col-lg-10 mx-auto">
                <div className="d-lg-flex justify-content-between gap-4">
                  ...
                  >
                    ...
                    <input
                      type="text"
                      name="name"
                      className="inpText w-100 d-block border border-dark border-1 px-3 py-2 shadow mt-1 mb-2"
                    />
                  </div>
                  <div
                    className="w-100 w-lg-50"
                ...
                <div className="d-lg-flex justify-content-between gap-4">
                  <div
                    ...
                    data-aos-delay="600"
                  >
                    <MdOutlineSubject className="fs-5" />{" "}
                    <label className="ms-1" htmlFor="">
                      Subject
                    </label>
                    <input
                  ...
                  <div
                    ...
                    data-aos-delay="600"
                  >
                    <BsFillFileImageFill className="fs-5" />{" "}
                    <label className="ms-1" htmlFor="">
                      Profile
                    </label>
                    <input
