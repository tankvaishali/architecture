...
function Whychooseus() {
  ...
  <div className="py-5">
    <div className="container overflow-hidden">
        <div className="row g-5 justify-content-center">
            ...
            <div className="col-12 col-lg-4">
                ...
                <div className="about-section justify-content-center pt-4">
                                    <div className="line  "></div>
                                    <span className=''>WHY CHOOSE US</span>
                                </div>
                                <h1 className="Discover text-dark py-3 text-center">We Can Build Your Dreams</h1>
      <div className=" py-2">Lorem ipsum dolor sit amet consectetur adipisicing elit. Facilis dolorem voluptate quos laboriosam consectetur reprehenderit magni alias recusandae dignissimos atque!</div>
   ...
   <div className='d-flex  align-content-center align-items-center'>
      ...
      <div className='whyno'><BiSolidPhoneCall /> 12345 67890</div>
                </div>
            </div>
            <div className="col-12 col-lg-4">
                <div className="h-100 shadow">
