...
function ProjectInnerList() {
    ...
    const [currentIndex, setCurrentIndex] = useState(null); // State for current image index
        ...
        <>
                    ...
                    {selectedInnerData?.img.map((item, i) => (
                        <div key={i} className="gallery-item my-5">
                            <Image
                                ...
                                height={600}
                                priority={item === '01'}
                                onClick={() => openImageBox(i)} // Open modal on image click
            ...
            {currentIndex !== null && (
                <div className="modal text-center" style={modalStyle}>
                    <button onClick={closeImageBox} className='btn btn-secondary' style={{ position: 'fixed', top: '6%', right: '3%' }}>
                        <X />
                    </button>

                    <button onClick={showPrevImage} className='btn btn-secondary' style={{ position: 'absolute', top: '40%', left: '5%' }}>
                        <ArrowBigLeft />
                    </button>
                    ...
                    <button onClick={showNextImage} className='btn btn-secondary' style={{ position: 'absolute', top: '40%', right: '5%' }}>
                        <ArrowBigRight />
                    </button>

                    <div className="thumbnail-container" style={{ marginTop: '47px' }}>
