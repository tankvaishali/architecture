            ...
            <div className="missionbg">
                <div className="py-4">
                    <div className="container py-3 py-lg-5 overflow-hidden">
                        <div class="about-sectionbck" data-aos="fade-up" data-aos-duration="1500">
                            <span>OUR MISSON</span>
                            <div class="linebck"></div>
                        </div>
                        <h1 class=" Discover  text-white py-2" data-aos="fade-down" data-aos-duration="1500">Designing inspiring and enduring spaces is our mission .</h1>
                        ...
                        <div className="row g-5 pt-0 pt-lg-4 overflow-hidden">
                            {
                                missiondata.map((x, i) => {
                                    return (
                                        <>
                                            <div className="col-12 col-md-6 col-lg-4 pt-3" data-aos={x.aos} data-aos-duration="1500" key={x.id}>
