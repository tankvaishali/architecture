            ...
            <div className='py-5 awardbg '>
                ...
                <div className="container">
                    <div className="py-3 py-lg-5">
                        ...
                        <h1 className="Discover text-dark py-3 text-center" data-aos="fade-down" data-aos-duration="1500">Our easy steps to get interior design</h1>
                    </div>
                    {
                        awardData.map((x, i) => {
                            return (
                                <>
                                    <div className="row g-3 border-top border-1 border-secondary-subtle py-3" data-aos="fade-up" data-aos-duration="1500" data-aos-delay={x.delay}>
                                        <div className="col-2">
