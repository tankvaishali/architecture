          ...
          <div className="py-5">
            <div className="row g-5">
              <div className="col-12 col-lg-6">
                <div style={{ height: 460 }} data-aos="fade-right" data-aos-duration="1500">
                  <img
              ...
              <div className="col-12 col-lg-6">
                <div className="h-100">
                  <div class="about-section" data-aos="fade-up" data-aos-duration="1500">
                    <div class="line"></div>
                    <span>ABOUT US</span>
                  </div>
                  <h1 class=" Discover  text-dark py-2" data-aos="fade-down" data-aos-duration="1500">Mr. Hiten Patel</h1>
                  <div className="pera" data-aos="fade-left" data-aos-duration="1500">
            ...
            <div className="counterset">
              <div class="row  my-3 justify-content-center">
                ...
                <div class="col-md-3" data-aos="zoom-in" data-aos-duration="1500" data-aos-delay="400">
                  <div class="stat-item bg-white p-4 rounded-4 text-center border-top border-4 border-secondary shadow-sm">
                    <div class="stat-number fw-medium"><CountUp end={780} enableScrollSpy={true} />+</div>
                    <div class="stat-label">Winning Award</div>
                  </div>
                </div>
                <div class="col-md-3" data-aos="zoom-in" data-aos-duration="1500" data-aos-delay="800">
                  <div class="stat-item bg-white p-4 rounded-4 text-center border-top border-4 border-secondary shadow-sm">
